<?php echo $header; ?>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <h3 class="light">Education Management</h3>
        </div>
      </div>
      <div class="col-md-6 pad-top-10">
        <div class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
                <li><a  data-toggle="modal" data-target="#addDialog"><i class="glyphicon glyphicon-plus"></i> Add Education</a></li>
                <li><a onclick="common_delete(1)" ><i class="glyphicon glyphicon-trash"></i> Delete</a></li>
          </ul>
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/add_update">
       ...
       <div class="modal-footer">
          ...
          <input type="hidden" name="tableId" id="tableId" value="1" />
          <input type="hidden" name="editId" id="editId" value="" />
          <input type="hidden" name="redirect_url" id="redirect_url" value="admin/education" />
...
<script type="text/javascript">
  ...
  draw_education_master_header();
  draw_education_master();  
</script>
