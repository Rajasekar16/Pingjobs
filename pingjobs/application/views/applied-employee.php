<?php echo $header; ?>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <h3 class="light">Applied Employee</h3>
        </div>
      </div>
      <div class="col-md-6 pad-top-10">
        <div class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
                ...
                <!-- <li><a onclick="common_delete(5)" ><i class="glyphicon glyphicon-trash"></i> Delete</a></li> -->
          </ul>
...
<script type="text/javascript">
  ...
  draw_employee_master_header();
  draw_employee_master();  
</script>
