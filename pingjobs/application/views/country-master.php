<?php echo $header; ?>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <h3 class="light">Country Management</h3>
        </div>
      </div>
      <div class="col-md-6 pad-top-10">
        <div class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a  data-toggle="modal" data-target="#addDialog"><i class="glyphicon glyphicon-plus"></i> Add Country</a></li>
            <li><a onclick="common_delete(7)" ><i class="glyphicon glyphicon-trash"></i> Delete</a></li>
          </ul>
    ...
    <div class="modal-content">
	  ...
	  ?>
       ...
       <div class="modal-footer">
          ...
          <input type="hidden" name="tableId" id="tableId" value="7" />
          <input type="hidden" name="editId" id="editId" value="" />
          <input type="hidden" name="redirect_url" id="redirect_url" value="admin/country" />
